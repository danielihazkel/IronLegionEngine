...
| 120 velites (loose) fire 8 volleys at 120 hastati (line) at 35 m, no approach (`volley_velites_vs_hastati`, T2-030) | Hastati lose 15–35 soldiers (`casualties` 0.125–0.292 of 120 in ≥ 90 % of seeds; carried inactive until landing exists, T2-031). | — |
