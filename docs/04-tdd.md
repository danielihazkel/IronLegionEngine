...
pub enum Transition { StartBattle(PathBuf), StartSetup { setup: Box<BattleSetup>, stem, ai } /* the builder, Rematch; T2-091 */, LoadSave(PathBuf) /* T2-101 */, QuitToMenu }
pub struct Settings { ui_scale: f32, vsync: bool, fullscreen: bool, threads: usize, volume: Volume { master, effects, music }, bindings: Vec<BindingOverride { action, keys }>, replays_dir: String, saves_dir: String }   // il_app::settings, T2-091
