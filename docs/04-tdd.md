...
pub mod interface {
    ...
    pub struct RegimentResult { pub id: u32, pub initial: u16, pub survivors: u16, pub fled: u16, pub killed: u16, pub experience_gain: u16, pub ammo_left: u16, pub arrived: bool /* false for a reinforcement group that never entered, T2-070 */,
        pub units: Vec<UnitGroupResult { unit_type: ContentId, initial: u16, survivors: u16, killed: u16, fled: u16 }> /* T3-002 (SIM-FORM-015), declared in T3-040 (empty), filled from T3-041: one row per unit group in setup order, summing to the totals; a single-group regiment has one row */ }
