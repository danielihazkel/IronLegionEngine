...
| T-9 | Four of the 18 stages (1, 8, 12, 14, 16; Stages 9, 10 and 15 got their systems in T2-020, T2-021 and T2-022, Stage 11 in T2-031, Stage 13 in T2-040) run an empty placeholder system so the profiler shows every row; together they cost ≈ 0.3 ms of schedule overhead per tick at 20k | Debt | il_sim_battle | Each placeholder is replaced by its real systems in Phase 2; if any stage stays empty after that, drop its schedule. |
