...
- [ ] The AI wins against a passive player (T2-082): `ai_vs_passive` 3/20 seeds on 2026-09-07 in release after the tuning pass (the fallback army of plan I15 13/20); see the T2-082 finding. Open: the owner's decision.
- [ ] Scenario band tests pass (T2-110): 2026-09-07 in release, `bands.md` (14 pass, 1 fail: the AI passive row).
