...
- [ ] `il_cli validate game/` is clean in CI (clean locally on 2026-09-03: 0 errors, 0 warnings; the box waits for the push and the CI run, which also repeats the determinism proof and the bench comparison).
