...
| OQ-8 | Audio crate: `kira` (game-oriented) or `rodio`? Leaning `kira`, with placeholder samples written by an `il_cli gensound` generator (decided with the T2-091 milestone plan, 2026-09-06); resolved when T2-100 lands it. | TDD audio section | Phase 2 |
