...
pub fn validate(opts: &ValidateOptions, out: &mut dyn Write) -> anyhow::Result<ValidateReport> {
        ...
        && let Some(regs) = &report.registries
    {
        ...
        writeln!(
            out,
            "units {} · formations {} · group formations {} · factions {} · zones {} · maps {} · sprite sets {} · sound sets {} · abilities {} · AI action sets {} · AI profiles {} · locale languages {}",
            regs.units.len(),
            regs.formations.len(),
            ...
            regs.sound_sets.len(),
            regs.abilities.len(),
            regs.ai_action_sets.len(),
            regs.ai_profiles.len(),
