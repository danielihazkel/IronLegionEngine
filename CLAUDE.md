...
- `docs/09-tasks-phase-3-4.md` is the active task list (Phase 3 opens with the Phase 2 carry-over; `docs/07-tasks-phase-0-2.md` holds Phases 0–2). Tick a box only when its **Done when** holds.
